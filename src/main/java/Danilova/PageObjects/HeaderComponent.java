...
public class HeaderComponent {
    ...
    @Step("Get d logo AE_Header")
    public boolean isEqualDAE_Header(String d){
        return Objects.equals(this.d_logoAE_Header, d);
    }

    @Step("Check logo hint")
    public By getTextHintLogo(){
        return logoAE_Header_hint;
    }
